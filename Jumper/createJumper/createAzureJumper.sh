...
az vm create -n bbw-jumper-$vmname -g csm-bbw --image $image --custom-data $userdata --ssh-key-value $sshpubkey --public-ip-sku Standard --nic-delete-option delete --admin-username centos --tags Owner=$owner Project=$project $default_tags